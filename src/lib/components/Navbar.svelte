...
<header class="fixed z-navBar transition-transform md:h-full md:relative -translate-x-full md:translate-x-0 w-full h-screen md:col-span-3 bg-daisyBush text-center"
